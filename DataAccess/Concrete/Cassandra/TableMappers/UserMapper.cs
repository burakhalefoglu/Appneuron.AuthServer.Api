...
public class UserMapper : Mappings
{
    public UserMapper()
    {
        ...
        For<User>()
            ...
            .Column(u => u.UpdateContactDate,
                cm => cm.WithName("update_contact_date").WithDbType(typeof(DateTimeOffset)))
            ...
            .Column(u => u.ResetPasswordExpires,
                cm => cm.WithName("reset_password_expires").WithDbType(typeof(DateTimeOffset)))
