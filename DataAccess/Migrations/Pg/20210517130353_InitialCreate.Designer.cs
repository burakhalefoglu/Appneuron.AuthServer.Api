...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20210517130353_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Client", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ClientClaim", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ClientGroup", b =>
                {
                    b.Property<long>("ClientId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.UserClaim", b =>
                {
                    ...
                    b.HasKey("ClaimId", "UsersId");

                    b.HasIndex(new[] { "UsersId", "ClaimId" }, "Uk_Uniqe")
                        .IsUnique();
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ClientClaim", b =>
                {
                    b.HasOne("Core.Entities.Concrete.OperationClaim", "Claim")
                    ...
                    b.HasOne("Core.Entities.Concrete.Client", "Clients")
                        .WithMany("ClientClaims")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.ClientGroup", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Client", "client")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Translate", b =>
                {
                    b.HasOne("Core.Entities.Concrete.Language", "Languages")
                        .WithMany("Translates")
                        .HasForeignKey("LangId")
                        .HasConstraintName("FK_Translates_Id_LangId")
                        .IsRequired();
