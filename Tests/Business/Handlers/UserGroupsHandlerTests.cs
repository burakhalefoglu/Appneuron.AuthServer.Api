...
namespace Tests.Business.Handlers
{
    ...
    public class UserGroupsHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _updateUserGroupByGroupIdCommandHandler = new UpdateUserGroupByGroupIdCommandHandler(_userGroupRepository.Object);
            ...
            _getUsersInGroupLookupByGroupIdQueryHandler = new GetUsersInGroupLookupByGroupIdQueryHandler(_userGroupRepository.Object);
        ...
        public void Handler_GetUserGroup_Success()
        {
            ...
            _userGroupRepository.Setup(x =>
                    x.GetAsync(It.IsAny<Expression<Func<UserGroup, bool>>>())).
                            ReturnsAsync(new UserGroup());

            var result = _getUserGroupQueryHandler.Handle(query, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        ...
        public void Handler_GetUsersInGroupLookupByGroupId_Success()
        {
            ...
            var result = _getUsersInGroupLookupByGroupIdQueryHandler.Handle(query, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        ...
        public void Handler_GetUserGroupLookupQuery_Success()
        {
            ...
            _userGroupRepository.Setup(x =>
                    x.GetUserGroupSelectedList(It.IsAny<int>())).
                            ReturnsAsync(new List<SelectionItem>().AsQueryable());

            var result = _getUserGroupLookupQueryHandler.Handle(query, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        ...
        public void Handler_GetUserGroupLookupByUserIdQuery_Success()
        {
            ...
            var result = _getUserGroupLookupByUserIdQueryHandler.Handle(query, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        ...
        public void Handler_CreateUserGroupClaims_Success()
        {
            ...
            var result = _createUserGroupClaimsCommandHandler.Handle(createUserCommand, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        }
        ...
        public void Handler_UpdateUserGroupByGroupId_Success()
        {
            ...
            var result = _updateUserGroupByGroupIdCommandHandler.
                            Handle(updateUserCommand, new System.Threading.CancellationToken()).Result;
            result.Success.Should().BeTrue();
        }
